...
export default function GapDonut({ skillsCount, gapCount }: GapDonutProps) {
    ...
    return (
        <Box sx={{ width: '100%', minWidth: 180, minHeight: 180, height: { xs: 180, sm: 220 }, display: 'flex', justifyContent: 'center' }}>
            <ResponsiveContainer width="100%" height="100%" minWidth={180} minHeight={180} style={{ background: 'transparent' }}>
                <PieChart>
                    <Pie
                        data={data}
                        cx="50%"
